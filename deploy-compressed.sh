...
echo "🚀 Deploy MarVera con archivo comprimido"
echo "========================================"

# Crear directorio temporal para el build
echo "📦 Preparando archivos para compresión..."
mkdir -p deploy-temp
...
rm -rf deploy-temp
rm -f marvera-complete.tar.gz

echo ""
echo "🎉 Deploy completado exitosamente!"
echo "🌐 URL: https://marvera.mx"
