    ...
    <div className="bg-background min-h-screen main-content">
          ...
          <div className="relative bg-gradient-to-br from-deep-navy via-dark-blue to-vibrant-blue rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden shadow-lg sm:shadow-xl lg:shadow-2xl">
            ...
            <div className="relative flex flex-col lg:flex-row items-center min-h-[400px] sm:min-h-[450px] md:min-h-[500px] lg:min-h-[400px] xl:min-h-[450px]" style={{  backgroundImage: 'url(/fondorectangulo3.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
              ...
              <div className="flex-1 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 text-white relative z-20">
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl mb-6 sm:mb-8 md:mb-10 max-w-2xl leading-relaxed" style={{ color: 'white' }}>
                ...
                <Link 
                  to="/products"
                  className="bg-vibrant-blue text-white hover:bg-light-peach hover:text-deep-navy font-semibold py-3 sm:py-4 md:py-5 lg:py-6 px-6 sm:px-8 md:px-10 lg:px-12 rounded-lg sm:rounded-xl transition-all duration-300 inline-flex items-center group hover-lift btn-gradient-primary text-base sm:text-lg lg:text-xl shadow-lg hover:shadow-xl"
                >
                  Ver productos
                  <ChevronRightIcon className="h-5 w-5 sm:h-6 sm:w-6 ml-2 sm:ml-3 transition-transform duration-300 group-hover:translate-x-1" />
                </Link>
              </div>
              {/* Seafood Image */}
            </div>
      ...
      <section className="py-6 sm:py-8 md:py-10 lg:py-12 xl:py-16 bg-light">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 xl:px-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-6 sm:mb-8 lg:mb-10 text-center">Productos Destacados</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-md sm:shadow-lg hover:shadow-xl transition-all duration-300 hover-lift group">
              ...
              <div className="p-4 sm:p-5 md:p-6 lg:p-7">
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3 group-hover:text-primary transition-colors duration-300">Salmón Salvaje</h3>
                <p className="text-gray-600 text-sm sm:text-base mb-3 sm:mb-4 md:mb-5">Origen sostenible, sabor intenso</p>
                <button className="w-full bg-button hover:bg-primary text-white font-medium py-2.5 sm:py-3 px-4 sm:px-5 rounded-lg sm:rounded-xl transition-all duration-300 hover-lift btn-gradient-primary group text-sm sm:text-base">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-md sm:shadow-lg hover:shadow-xl transition-all duration-300 hover-lift group">
              ...
              <div className="p-4 sm:p-5 md:p-6 lg:p-7">
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3 group-hover:text-primary transition-colors duration-300">Langosta Viva de Maine</h3>
                <p className="text-gray-600 text-sm sm:text-base mb-3 sm:mb-4 md:mb-5">Entrega viva para máxima frescura</p>
                <button className="w-full bg-button hover:bg-primary text-white font-medium py-2.5 sm:py-3 px-4 sm:px-5 rounded-lg sm:rounded-xl transition-all duration-300 hover-lift btn-gradient-primary group text-sm sm:text-base">
                  <span className="group-hover:scale-105 transition-transform duration-300 inline-block">Agregar al carrito</span>
                </button>
              </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-md sm:shadow-lg hover:shadow-xl transition-all duration-300 hover-lift group">
              ...
              <div className="p-4 sm:p-5 md:p-6 lg:p-7">
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3 group-hover:text-primary transition-colors duration-300">Ostras Premium</h3>
                <p className="text-gray-600 text-sm sm:text-base mb-3 sm:mb-4 md:mb-5">Cosechadas a diario, saladas y deliciosas</p>
                <button className="w-full bg-button hover:bg-primary text-white font-medium py-2.5 sm:py-3 px-4 sm:px-5 rounded-lg sm:rounded-xl transition-all duration-300 hover-lift btn-gradient-primary group text-sm sm:text-base">
                  <span className="group-hover:scale-105 transition-transform duration-300 inline-block">Agregar al carrito</span>
                </button>
              </div>
      ...
      <section className="py-6 sm:py-8 md:py-10 lg:py-12 xl:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 xl:px-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-6 sm:mb-8 lg:mb-10 text-center">Ofertas Especiales</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="relative bg-gray-100 rounded-xl sm:rounded-2xl overflow-hidden">
              ...
              <div className="p-4 sm:p-5 md:p-6 lg:p-7">
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">Banquete de Mariscos de Verano</h3>
                <p className="text-gray-600 text-sm sm:text-base">Aprovecha 20% de descuento en combos seleccionados</p>
              </div>
            </div>
            ...
            <div className="relative bg-gray-100 rounded-xl sm:rounded-2xl overflow-hidden">
              ...
              <div className="p-4 sm:p-5 md:p-6 lg:p-7">
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">Especiales de Mariscos para Fiestas</h3>
                <p className="text-gray-600 text-sm sm:text-base">Celebra con nuestras selecciones festivas de mariscos</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-6 sm:py-8 md:py-10 lg:py-12 xl:py-16 bg-light">
        <div className="max-w-4xl mx-auto text-center px-2 sm:px-4 lg:px-6 xl:px-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-3 sm:mb-4 md:mb-5">Suscríbete a Nuestro Boletín</h2>
          <p className="text-gray-600 mb-6 sm:mb-8 lg:mb-10 text-sm sm:text-base md:text-lg leading-relaxed max-w-2xl mx-auto">Recibe novedades sobre las mejores capturas, ofertas exclusivas y recetas deliciosas.</p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 justify-center items-stretch sm:items-center max-w-sm sm:max-w-md md:max-w-lg mx-auto">
            <input 
              type="email" 
              placeholder="Ingresa tu correo electrónico" 
              className="w-full sm:flex-1 px-4 sm:px-5 py-3 sm:py-4 md:py-5 border border-gray-300 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200 hover:border-accent hover:shadow-md text-base sm:text-lg"
            />
            <button className="w-full sm:w-auto bg-button hover:bg-primary text-white font-semibold py-3 sm:py-4 md:py-5 px-6 sm:px-8 lg:px-10 rounded-lg sm:rounded-xl transition-all duration-300 whitespace-nowrap hover-lift btn-gradient-primary group text-base sm:text-lg">
