...
const SAMPLE_FEATURED_PRODUCTS: FeaturedProduct[] = [
  {
    ...
    price: 89.99,
    image: `https://images.unsplash.com/photo-1565299624946-3fb11f5e6747?w=400&h=300&fit=crop&crop=center`,
    category: "pescados",
    emoji: "🐟",
    tag: "Destacado",
  ...
  },
  {
    ...
    price: 125.50,
    image: `https://images.unsplash.com/photo-1559181089-95d742d40ba5?w=400&h=300&fit=crop&crop=center`,
    category: "mariscos",
    emoji: "🦐",
    tag: "Popular",
  ...
  },
  {
    ...
    price: 156.00,
    image: `https://images.unsplash.com/photo-1572276910090-ae8e0f12d46e?w=400&h=300&fit=crop&crop=center`,
    category: "moluscos",
    emoji: "🦪",
    tag: "Premium",
...
// Thunk simplificado - siempre usa datos locales
export const fetchFeaturedProducts = createAsyncThunk(
  'featuredProducts/fetchFeaturedProducts',
  async () => {
    // Simular una pequeña demora para mostrar loading
