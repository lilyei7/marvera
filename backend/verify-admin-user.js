...
async function verifyAdminUser() {
  try {
    ...
    // Verificar que el role sea ADMIN o SUPER_ADMIN
    if (adminUser.role === 'ADMIN' || adminUser.role === 'SUPER_ADMIN') {
      console.log(`✅ Role ${adminUser.role} verificado correctamente`);
    } else {
      console.log(`❌ Role incorrecto: esperado ADMIN o SUPER_ADMIN, obtenido ${adminUser.role}`);
      return false;
    }
